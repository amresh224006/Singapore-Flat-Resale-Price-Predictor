...
Original file is located at
    https://colab.research.google.com/drive/1B7wx58p57kJ0YsDAMfL0SnKbCFf8wxcx
"""
...
with tab3:
    ...
    if st.button('Predict and Conclusion'):
            ...
            def load_data():
                # Load data
                data = pd.read_csv(r'/content/final.csv')
...
! streamlit run final_py\ \(1\).py & npx localtunnel --port 8501